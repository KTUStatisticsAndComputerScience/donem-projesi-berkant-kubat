...
import {useIllerState} from "@/states/iller_state";
import {useIlcelerState} from "@/states/ilceler_state";

import AdresModalComponent from "@/components/modal/AdresModalComponent.vue";
...
const illerStore = useIllerState();
const ilcelerStore = useIlcelerState();
...
const eklenecek_ilce = ref({
  ilceadi: '',
  adres: '',
  sehirId: ''
});
const eklenecek_il = ref({
  ilAdi: '',
  adres: '',
  ilce: ''
});
...
function alici_iptal() {
  eklenecek_alici.value.ad = "";
  eklenecek_alici.value.soyad = "";
  eklenecek_alici.value.tcKimlik = "";
  eklenecek_alici.value.telNo = "";
  eklenecek_alici.value.email = "";
  eklenecek_alici.value.adres_id = "";
  alici_ekleme_acik.value = false;
}
function gonderici_iptal() {
  eklenecek_gonderici.value.ad = "";
  eklenecek_gonderici.value.soyad = "";
  eklenecek_gonderici.value.tcKimlik = "";
  eklenecek_gonderici.value.tcKimlik = "";
  eklenecek_gonderici.value.email = "";
  eklenecek_gonderici.value.adres_id = "";
  gonderici_ekleme_acik.value = false;
}
function kargo_iptal() {
  eklenecek_kargo.value.kargo_tarihi = "";
  eklenecek_kargo.value.subeId = "";
  eklenecek_kargo.value.kargo_odemeTuru = "";
  eklenecek_kargo.value.gondericiId = "";
  eklenecek_kargo.value.aliciId = "";
  kargo_ekleme_acik.value = false;
}

function adres_iptal() {
  eklenecek_adres.value.adres = "";
  eklenecek_adres.value.ilId = "";
  eklenecek_adres.value.ilceId = "";
  eklenecek_adres.value.adres_turu = "";
  adres_ekleme_acik.value = false;
}

function sube_iptal() {
  eklenecek_sube.value.ad="";
  eklenecek_sube.value.sube_yetkilisi="";
  eklenecek_sube.value.telNo="";
  eklenecek_sube.value.adres_id="";
  sube_ekleme_acik.value = false;
}
const sube_ad_hatali = computed(()=>{
  return eklenecek_sube.value.ad==="";
});
const sube_telNo_hatali = computed(()=>{
  return eklenecek_sube.value.telNo==="";
});
const sube_yetkilisi_hatali = computed(()=>{
  return eklenecek_sube.value.sube_yetkilisi==="";
});
const sube_adres_id_hatali = computed(()=>{
  return eklenecek_sube.value.adres_id==="";
});
const alici_ad_hatali = computed(() => {
  return eklenecek_alici.value.ad === "";
});
const alici_soyad_hatali = computed(() => {
  return eklenecek_alici.value.soyad === "";
});
const alici_telNo_hatali = computed(() => {
  return eklenecek_alici.value.telNo === "";
});
const alici_tcKimlik_hatali = computed(() => {
  return eklenecek_alici.value.tcKimlik === "";
});
const alici_email_hatali = computed(() => {
  return eklenecek_alici.value.email === "";
});
const alici_adres_id_hatali = computed(() => {
  return eklenecek_alici.value.adres_id === "";
});
const gonderici_ad_hatali = computed(() => {
  return eklenecek_gonderici.value.ad === "";
});
const gonderici_soyad_hatali = computed(() => {
  return eklenecek_gonderici.value.soyad === "";
});
const gonderici_tcKimlik_hatali = computed(() => {
  return eklenecek_gonderici.value.tcKimlik === "";
});
const gonderici_telNo_hatali = computed(() => {
  return eklenecek_gonderici.value.telNo === "";
});
const gonderici_email_hatali = computed(() => {
  return eklenecek_gonderici.value.email === "";
});
const gonderici_adres_id_hatali = computed(() => {
  return eklenecek_gonderici.value.adres_id === "";
});
const adres_hatali = computed(() => {
  return eklenecek_adres.value.adres === "";
});
const adres_il_hatali = computed(() => {
  return eklenecek_adres.value.ilId === "";
});
const adres_ilce_hatali = computed(() => {
  return eklenecek_adres.value.ilceId === "";
});
...
ModalComponent(:acik="kargo_ekleme_acik")
  ...
  template(#kargo_icerik)
    div.form
      ...
      select(name="sube", id="sube", v-model="eklenecek_kargo.subeId")
        option(value="eklenecek_sube.id") KTÜ
        option(value="eklenecek_sube.id") Değirmendere
        option(value= "eklenecek_sube.id") Samsun
      span.hata(v-if="kargo_sube_hatali") Şube Bilgisini Düzeltin
      label(for="odemeTuru") Ödeme Türü
      select(name="odemeTuru", id="odemeTuru", v-model="eklenecek_kargo.kargo_odemeTuru" )
        option(value="odemeTuru-1") Gonderici Odemeli
        option(value="odemeTuru-2") Alici Odemeli
  ...
  template(#gonderici_icerik)
    div.form
      ...
      select(name="gonderici_bilgileri", id="gonderici_bilgileri", v-model="eklenecek_kargo.gondericiId" )
        option(value="gonderici-1") yavuzhan tuğrul
        option(value="gonderici-2") gündüz ersoy
        option(value="gonderici-3") berkant kubat
  ...
  template(#alici_icerik)
    div.form
      ...
      select(name="alici_bilgileri", id="alici_bilgileri", v-model="eklenecek_kargo.aliciId" )
        option(value="alici-1") gündüz ersoy
...
AdresModalComponent(:acik="adres_ekleme_acik")
  ...
  template(#icerik)
    div.form
      ...
      label(for="il") İl
      select(name="adres_il", id="adres_il", v-model="eklenecek_adres.ilId" )
        option(value="il_bilgileri.id",v-for="il_bilgileri in illerStore.iller") {{il_bilgileri.ilAdi}}
      span.hata(v-if="adres_il_hatali") Adres İl Bilgisini Düzeltin!

      label(for="ilce") İlçe
      select(name="adres_ilce", id="adres_ilce", v-model="eklenecek_adres.ilceId")
        option(value="ilcelerStore.ilceler.id",v-for="ilce_bilgileri in ilcelerStore.ilceler") {{ilce_bilgileri.ilceadi}}
      span.hata(v-if="adres_ilce_hatali") Adres İlce Bilgisini Düzeltin!
...
AdresModalComponent(:acik="gonderici_ekleme_acik")
  ...
  template(#icerik)
    div.form
      ...
      input(type="text", name="gonderici_adi", id="gonderici_adi", v-model="eklenecek_gonderici.gondericiBilgileri_ad")
      span.hata(v-if="gonderici_ad_hatali") Gönderici Adı Bilgisini Düzeltin!
      labe(for="gonderici_soyad") Gönderici Soyad
      input(type="text", name="gonderici_soyad", id="gonderici_soyad", v-model="eklenecek_gonderici.gondericiBilgileri_soyad")
      ...
      input(type="text", name="gonderici_tcKimlik", id="gonderici_tcKimlik", v-model="eklenecek_gonderici.gondericiBilgileri_tcKimlik")
      ...
      input(type="text", name="gonderici_telNo", id="gonderici_telNo", v-model="eklenecek_gonderici.gondericiBilgileri_telNo")
      ...
      input(type="text", name="gonderici_email", id="gonderici_email", v-model="eklenecek_gonderici.gondericiBilgileri_email")
      span.hata(v-if="gonderici_email_hatali") Gönderici E-Mail Bilgisini Düzeltin!
      label(for="gonderici_adres_id") Gönderici Adresi
      select(name="gonderici_adres_id", id="gonderici_adresId", v-model="eklenecek_gonderici.gondericiBilgileri_adresId")
        option(value="g-adres-1") esenevler mh
...
AdresModalComponent(:acik="alici_ekleme_acik")
  ...
  template(#icerik)
    div.form
      ...
      select(name="alici_adres_id", id="alici_adresId", v-model="eklenecek_alici.alici_adresId")
...
AdresModalComponent(:acik="sube_ekleme_acik")
  ...
  template(#icerik)
    div.form
      ...
      select(name="sube_adres_id", id="sube_adresId", v-model="eklenecek_sube.sube_adresId")
        option(value="g-adres-1") Merfa Mh. Aksaray
        option(value="g-adres-2") Üniversite Mh. Trabzon
        option(value="g-adres-3") Yomra Trabzon
